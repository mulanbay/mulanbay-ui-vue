<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        <el-button type="stat" icon="el-icon-s-data" size="mini" @click="handleQuery" v-hasPermi="['read:readingRecordDetail:dateStat']">统计</el-button>
...
<script>
  import {getReadingRecordDetailDateStat} from "@/api/read/readingRecordDetail";
...
export default {
  ...
  methods: {
    ...
    initChart() {
      ...
      getReadingRecordDetailDateStat(this.addDateRange(this.queryParams, this.dateRange)).then(
        response => {
          //组装chart数据
