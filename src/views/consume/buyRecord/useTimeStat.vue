<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        <el-button type="stat" icon="el-icon-s-data" size="mini" @click="handleQuery" v-hasPermi="['consume:buyRecord:useTimeStat']">统计</el-button>
...
<script>
  import {getBuyRecordUseTimeStat} from "@/api/consume/buyRecord";
...
export default {
  ...
  created() {
    ...
    this.getDictItemTree('BUY_RECORD_USE_TIME_STAT_GROUP_FIELD',false).then(response => {
