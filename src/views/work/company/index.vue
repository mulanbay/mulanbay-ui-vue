<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        <el-button type="query" icon="el-icon-search" size="mini" @click="handleQuery" v-hasPermi="['work:company:query']">搜索</el-button>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleCreate"
          v-hasPermi="['work:company:create']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['work:company:delete']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['work:company:export']"
        >导出</el-button>
      </el-col>
    </el-row>
    ...
    <el-table v-loading="loading" :data="companyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="在职时间" align="center" width="120">
        <template slot-scope="{row}">
          <span>{{ formatWorkDays(row.days) }}</span>
        </template>
      </el-table-column>
...
<script>
import {fetchList,getCompany,createCompany,updateCompany,deleteCompany} from "@/api/work/company";
