      ...
      generalStat(para).then(
        response => {
          ...
          this.statData = {
            ...
            totalSportExerciseCount: data.totalSportExerciseCount.toFixed(1),
            totalReadingHours: data.totalReadingHours.toFixed(1),
            totalReadingCount: data.totalReadingCount.toFixed(1),
            totalMusicPracticeHours:data.totalMusicPracticeHours.toFixed(1),
            totalMusicPracticeCount:data.totalMusicPracticeCount.toFixed(1),
